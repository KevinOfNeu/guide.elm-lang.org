...
The [README](more.md) of `elm-sortable-table` has some nice guidance on how to use APIs like these and why they are designed as they are. You can also watch the API design session where Greg and I figured out an API for `elm-autocomplete` here:

{% embed url="https://www.youtube.com/watch?v=KSuCYUqY058" caption="" %}
